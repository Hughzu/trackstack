...
- `.github/workflows/terraform-serverless.yml` currently manages the temporary `serverless-next` environment with OIDC and can build a bootstrap Go Lambda artifact for first apply.
